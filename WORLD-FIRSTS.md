...
====================================================================
قائمةٌ مستقلّةٌ عمّا فوقها: ما أُغلق محكُّه على **معيار نجاحٍ خُتم قبل
التشغيل**، فلم يعد ترشيحًا. النصُّ المعتمد لكلِّ مستحقٍّ يُنقل هنا **حرفًا**
كما خُتم في وثيقته، ولا يُحرَّر في هذا الملفّ ولا يُخلط بترشيحات ٢٠٢٦-٠٧-١٠.

---- ١ — التشغيل الآليّ الأعمى لمنهج الإسناد-والمتن على نطاق مدوّنة ----

السياق: أُغلق المحكُّ في ٣ آب ٢٠٢٦، ودليلُه بتمامه — المعيارُ المختوم قبل
التشغيل، ونتيجةُ إعادة الفحص، وحكمُ الإغلاق — في مستودع «التاريخ»:
`plan/HOLDOUT-MOTZKI.md` (§٧ المعيار · §٨ إعادة الفحص · §١٠ الإغلاق).

النصُّ المعتمد، منقولًا حرفًا من §٩ من تلك الوثيقة:

> **أول تشغيل آلي أعمى لمنهج الإسناد-والمتن (ICMA) على نطاق مدوّنة (٢ آب ٢٠٢٦):** خط أدوات «حلقة التاريخ» (مدوّنة ١٦٨٣ رواية → تسوية رواة بصفر تخمين → عنقدة متون → أشجار طرق بمعايير مدار معلنة) أعاد — وهو ممنوع من الاطلاع على الدراسات — إنتاجَ نتيجة Motzki 2001 اليدوية في روايات جمع القرآن (الزهري مدارًا وحيدًا لعنقود جمع أبي بكر عند كل العتبات، والزهري في عناقيد توحيد عثمان)، وأخرج استنساخًا ثانيًا غير مطلوب (الزهري مدارَ حزمة الأحرف السبعة بمعيار الفروع المعتضدة). المعايرة موثقة بمعيار نجاح مختوم قبل التشغيل في plan/HOLDOUT-MOTZKI.md.

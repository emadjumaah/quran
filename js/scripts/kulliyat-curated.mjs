...
/** الدفعةُ الثانية (2026-07-29، بأمر المالك: «التوسيعُ بالمراجعة نفسها») —
 *  الترشيحُ بالمعنى بيد المساعد، والتحقّقُ الآليُّ نفسُه، وتُعرض لمراجعة المالك. */
const BATCH2 = [
  // ── التوحيد وأسماء الله ──
  { loc: "2:163", bab: "التوحيد", title: "وحدانيّةُ الإله: إلهُكم إلهٌ واحد" },
  { loc: "7:180", bab: "التوحيد", title: "لله الأسماءُ الحسنى فادعوه بها" },
  { loc: "3:26", bab: "التوحيد", title: "مالكُ الملك يؤتيه من يشاء" },
  { loc: "11:6", bab: "التوحيد", title: "ضمانُ الرزق: ما من دابّةٍ إلا على الله رزقُها" },
  { loc: "65:3", bab: "التوحيد", title: "كفايةُ المتوكِّل وجعلُ قدرٍ لكل شيء" },
  { loc: "40:60", bab: "التوحيد", title: "وعدُ الإجابة: ادعوني أستجبْ لكم" },
  { loc: "30:30", bab: "التوحيد", title: "فطرةُ الله التي فطر الناسَ عليها" },

  // ── العدل والأخلاق الجامعة ──
  { loc: "17:23", bab: "العدل والإحسان", title: "قضاءُ الله: عبادتُه وحدَه والإحسانُ بالوالدين" },
  { loc: "6:152", bab: "العدل والإحسان", title: "مالُ اليتيم والوفاءُ بالكيل والعدلُ في القول" },
  { loc: "3:134", bab: "العدل والإحسان", title: "كظمُ الغيظ والعفوُ عن الناس" },
  { loc: "24:22", bab: "العدل والإحسان", title: "العفوُ والصفحُ رجاءَ مغفرة الله" },
  { loc: "2:83", bab: "العدل والإحسان", title: "ميثاقُ الإحسان: الوالدان والقربى واليتامى وقولُ الحسن" },

  // ── الاجتماع ──
  { loc: "3:159", bab: "الاجتماع", title: "لينُ الجانب والعفوُ والمشاورة" },
  { loc: "8:46", bab: "الاجتماع", title: "النهيُ عن التنازع المُفشِل المُذهِب للريح" },
  { loc: "49:11", bab: "الاجتماع", title: "النهيُ عن السخرية واللمز والتنابز" },
  { loc: "4:86", bab: "الاجتماع", title: "ردُّ التحيّة بأحسنَ منها" },
  { loc: "5:1", bab: "الاجتماع", title: "الأمرُ العامّ بالوفاء بالعقود" },
  { loc: "16:91", bab: "الاجتماع", title: "الوفاءُ بعهد الله وعدمُ نقض الأيمان" },

  // ── الجزاء ──
  { loc: "99:8", bab: "الجزاء", title: "رؤيةُ مثقالِ الذرّة من الشرّ" },
  { loc: "18:30", bab: "الجزاء", title: "لا يضيع أجرُ من أحسن عملًا" },
  { loc: "16:97", bab: "الجزاء", title: "الحياةُ الطيّبة جزاءُ العمل الصالح مع الإيمان" },
  { loc: "45:15", bab: "الجزاء", title: "العملُ لصاحبه: من عمل صالحًا فلنفسه" },

  // ── الابتلاء والصبر ──
  { loc: "67:2", bab: "الابتلاء", title: "الموتُ والحياةُ ابتلاءً لإحسان العمل" },
  { loc: "2:153", bab: "الابتلاء", title: "الاستعانةُ بالصبر والصلاة" },
  { loc: "29:2", bab: "الابتلاء", title: "لا يُترك المؤمنون بلا فتنةٍ تمحّص" },

  // ── اليسر ورفع الحرج ──
  { loc: "4:28", bab: "اليسر", title: "إرادةُ الله التخفيفَ عن الإنسان الضعيف" },
  { loc: "65:7", bab: "اليسر", title: "سيجعل اللهُ بعد عسرٍ يسرًا" },

  // ── الرسالة ──
  { loc: "34:28", bab: "الرسالة", title: "عمومُ الرسالة للناس كافّة" },
  { loc: "16:125", bab: "الرسالة", title: "منهاجُ الدعوة: الحكمةُ والموعظةُ والجدالُ بالأحسن" },

  // ── كرامةُ الإنسان والكون ──
  { loc: "30:21", bab: "الإنسان والكون", title: "آيةُ الأزواج: السكنُ والمودّةُ والرحمة" },
  { loc: "31:20", bab: "الإنسان والكون", title: "تسخيرُ ما في السماوات والأرض للإنسان" },
  { loc: "95:4", bab: "الإنسان والكون", title: "خلقُ الإنسان في أحسن تقويم" },
];
const CURATED = [...BATCH1, ...BATCH2];
...
const payload = {
  meta: {
    date: "2026-07-29",
    batches: { "2026-07-21": 50, "2026-07-29": 32 }, // ٨٢ = ٥٠ + ٣٢

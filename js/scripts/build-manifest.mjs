...
const layers = [
  ...
  {
    id: "mizan", label: "ميزان الأقوال (بطاقات الفحص المنشورة)", file: "fahis-cards.json", grade: "mahsub",
    anchors: ["term"], route: "/fahis",
    desc: "أقوالٌ معاصرةٌ عن ألفاظ التنزيل فُحصت بالاستقراء المحسوب: القولُ المحرَّر وحكمُه (تستقيم/تحتاج تقييدًا/لا تستقيم/لم يتبيّن) بشواهده المرتَّبة وحدودِ ما يلزم — كلُّ سؤالٍ عن صحة قولٍ أو دعوى («هل صحّ أن…»، «ليس في القرآن…»، «اللفظان مترادفان») يبدأ هنا؛ الحكمُ يُنقل بنصّه وحدوده، والفكرةُ تُبحث لا قائلُها",
    count: read("fahis-cards.json").cards.length,
  },
  {

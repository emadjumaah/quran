 ...
 *
 * ووقفُ «التلقين» **على ما لم يتمّ من عملنا لا على قرارٍ ولا على رخصة**:
 * التلاوةُ صارت عندنا (رُفعت ١٤ أغسطس ٢٠٢٦)، وبقي **توقيتُ الكلمات** الذي به
 * يتبع المؤشّرُ صوتَ القارئ المحقَّق.
 *
 * **وسببُ الوقف يُصوَّب متى بطَل** — فالاعتذارُ بعذرٍ زال أسوأُ من الوقف نفسِه:
 * يقرؤه القارئُ فيصدّقه، ويبني عليه انتظارًا لا محلَّ له.
 */
...
export const HALAT: Hal[] = [
  ...
  {
    // **فُتح ما هو حرٌّ منها** (أمرُ المالك ١٤ أغسطس · `SAWT-PLAN.md` §١٣): عندنا
    // **محرّكان لا واحد** — أحكامٌ سبعةٌ نحسبها من رسم المصحف الذي نملك رخصتَه،
    // ومقاديرُ مدٍّ من مرجعٍ غيرِ معلَن الرخصة. **فوقفُ البابِ كلِّه كان أوسعَ من
    // الحقّ**: يمضي ما يقوم على الأحكام، وتبقى المقاديرُ والمِسطرةُ موقوفتين
    // بسببهما المعلن. **والحدُّ الذي لا يُتجاوز أشدُّ من الرخصة**: تُعرض الأحكامُ
    // على **نصّ المصحف** ولا يُحكَم على تلاوة قارئ — فالفرقُ بين «هذا حكمُ
    // الموضع» و«أنت أخطأتَ فيه» هو الفرقُ بين عرضٍ ودعوى.
    id: "ard",
    name: "العَرْض",
    what:
      "تُشعَل أحكامُ التجويد في النصّ محسوبةً من رسم المصحف · وبعد الختام مواضعُ للنظر. " +
      "وأمّا قياسُ مقادير المدّ ومعايرةُ تلاوتك فينتظران ثبوتَ رخصةِ مرجعهما وعرضَهما على مختصٍّ في التجويد.",
    text: "shown",
    after: "places",
  },
  {
    ...
    text: "shown",
    after: "places",
    suspended: "التلاوةُ صارت عندنا، ويبقى توقيتُ الكلمات — وبه يتبع المؤشّرُ صوتَ القارئ المحقَّق",
  },
];

...
const DEFAULTS: Settings = {
  script: "uthmani",
  // **خطُّ المصحف الافتراضيّ — «أميري قرآن»** (ج٥، ١٤ أغسطس ٢٠٢٦). وثلاثُ عللٍ
  // مقيسةٍ لا ذوقٌ: (١) **رخصتُه وحدَها ثابتةٌ نظيفة** — OFL 1.1 بلا اسمٍ محجوز،
  // وهو من حزمةِ ناشره لا من تقطيعٍ عندنا (وحالُ الآخرَين مقيَّدةٌ في `CREDITS.md`)؛
  // (٢) **وأهدأُ الثلاثة فجوةً** في السطر المسوَّى (أوسعُ فجوةٍ ١٨٫٩px وتفاوتٌ ٣٫٢٦
  //     مقابل ٢٥٫٠/٤٫٥٧ لشهرزاد و٢٧٫٠/٥٫٥٩ لخطّ المجمَّع، مقيسةً في المتصفّح)؛
  // (٣) **ولا يزيد على وزن الحزمة بايتًا** — فهو مشحونٌ في البناء أصلًا.
  // **والخيارُ باقٍ للقارئ** في الإعدادات، وإنّما تغيّر الافتراض.
  quranFont: "amiri",
  numerals: "auto",
  quranScale: 1,
  theme: "auto",

...
export default function About() {
  ...
  const METHODS = ar
    ? [
        ["المحكمات والجوامع", "نتتبّع في القرآن جُمَلَه المُحكَمة، ثم نبني شبكةً من توارُدها — أيُّ المعاني يجتمع مع أيّ في الآيات — فتنتظم في هرمٍ من القاعدة التفصيلية إلى الأصول الجامعة الكبرى، كلُّه بالإحصاء بلا ترتيبٍ مسبق."],

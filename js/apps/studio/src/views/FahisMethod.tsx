  ...
  return (
    <div className="page page-narrow fahis" dir="rtl" lang="ar">
      ...
      <section>
        ...
        <p className="lim" style={{ marginTop: 8 }}>
          وتحرس الأرقامَ المنشورةَ مسابرُ مجمَّدة: تسعةٌ وعشرون رقمًا معلومَ
          الحكم يُعاد حسابُها من قاعدة الوسم قبل كلِّ نشر — فإن انحرف رقمٌ لم
          يمرَّ النشرُ حتى يُنظر؛ وما تكشفه يُصحَّح بمراجعةٍ ظاهرةٍ على البطاقة
          نفسِها بتاريخها وعلّتها، لا بمحوٍ صامت.
        </p>
      </section>

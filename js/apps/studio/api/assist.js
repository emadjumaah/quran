...
- layer_of للطبقات المسماة في قسم «طبقات مشكاة» (فروقٌ وشبكة جذورٍ ووجوهٌ وأمثالٌ وإحصاءٌ وقراءاتٌ وإعراب…)، وsearch_layer للبحث داخل كتابٍ أو عائلةٍ بعينها — إذا مسّ السؤالُ طبقةً منها فاستدعِها؛ فأنت نافذةُ مشكاة كلِّها لا القرآنِ وحده.
